...
public class MyClientTwo {
    ...
    public static MyClientTwo initConnection(String host, Integer port) throws IOException {
        MyClientTwo client = new MyClientTwo();
        client.host = host;
        client.port = port;
    ...
    public static void main(String[] args) throws IOException {
        MyClientTwo client = MyClientTwo.initConnection("localhost", 4444);
